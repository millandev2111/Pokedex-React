export const PokeBallSmall = ({...props}) => {
    return (
        <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2.3" stroke="#ff0000" fill="none" stroke-linecap="round" stroke-linejoin="round">
